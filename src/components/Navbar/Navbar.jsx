...
const [mobileMenu, setMobileMenu]=useState(false)
  const toggleMenu=()=>{setMobileMenu()
  ...
  return (
    <nav className={`container ${sticky?"dark-nav":""}`}>
      ...
      <ul className={mobileMenu?"":"hide-mobile-menu"}>
        <li><Link to='hero' smooth={true} offset={-290} duration={500}>Home</Link></li>
        <li><Link to='programs' smooth={true} offset={-150} duration={500}>Program</Link></li>
